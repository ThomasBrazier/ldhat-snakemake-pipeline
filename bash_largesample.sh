...
snakemake -s Snakefile_largesample -p -j 16 --configfile data/${1}/config.yaml --use-conda --use-singularity --nolock --rerun-incomplete --config dataset=${1} bpen=5 --until concatenate

...
figures = summarise.interval.figure(rates.file = gzfile(mcmc.file), burn.in = burn.in, locs.file = FALSE)
```
...
ggsave(paste(wdirpop, "/MCMC/", dataset, ".", chromosome, ".bpen", bpen, ".mixingRates.jpeg", sep = ""),
       plot = p, device = jpeg(), width = 14, height = 8, dpi = 300)
```

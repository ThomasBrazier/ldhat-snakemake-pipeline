...
snakemake -s workflow/Snakefile -p -j $ncores --configfile data/${dataset}/config.yaml --use-conda --rerun-incomplete --printshellcmds --config dataset=${dataset} chrom=${chrom} cores=$ncores

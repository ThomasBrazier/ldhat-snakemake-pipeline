...
# dataset = "Arabidopsis_thaliana_1001genomes" # DEBUG ONLY
# wdirpop = list.dirs(path = paste("data/", dataset, sep = ""))
# wdirpop = wdirpop[grepl("K", wdirpop)]
vcf_file = paste("../../data/", dataset, "/K", K, ".pop", pop, "/", dataset, ".chromosome.", chrom, ".ldhat.vcf.gz", sep = "")
